...
function layout(preheader: string, bodyHtml: string, logoSrc: string) {
  return `
...
export function buildInvitationEmail(inviteUrl: string, roleName: string, forWebPreview = false) {
  const html = layout(
